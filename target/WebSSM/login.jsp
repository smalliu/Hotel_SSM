...
<head>
    ...
    <style>
        ...
        body {
            font-family: 微软雅黑;
            margin: 0px;
            background-image: url('images/demo1bg.jpg');
            text-align: center;
        }
...
<%
    ...
    msgMap.put("1", "用户登录失败...");
    msgMap.put("noLogin", "您还没有登录，请先登录！");
    String errCode = request.getParameter("errCode");

    String message = msgMap.get(errCode);
...
<div id="outbox">
    <div id="title">缘来如此酒店管理系统</div>
    <div id="up_box">
        <table>
            <form id="userForm" action="${ctxPath}/User/login" method="post">
                <tr>
